...
<header>
    <nav>
        <div><a href="<?= base_url('/') ?>" id="home">Home</a></div>
        <div><a href="<?= base_url('/about') ?>" id="about">About</a></div>
        <div><a href="<?= base_url('/services') ?>" id="services">Services</a></div>
        <div><a href="<?= base_url('/contact') ?>" id="contact">Contact</a></div>
    </nav>
</header>
